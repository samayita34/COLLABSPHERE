...
export function usePermissions() {
    ...
    return {
        ...
        isGuest: (activeRole as string) === "GUEST",
        isAdmin: (activeRole as string) === "SUPER_ADMIN" || (activeRole as string) === "ORGANIZATION_ADMIN" || (activeRole as string) === "WORKSPACE_ADMIN",
    };
}
